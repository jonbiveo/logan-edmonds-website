<template>
  <v-card max-width="900px" class="mx-auto mb-12">
    ...
    <v-card-text class="px-8">
      JavaScript (ES6/ES7), Java, Vue.js, React, Nuxt.js, Node.js, HTML, CSS, Spring Boot, Bootstrap, Vuetify, PostgreSQL, MongoDB
    </v-card-text>
    <v-card-text class="mb-n7 text-subtitle-1 font-weight-bold">
      Tools, Techniques & OS
    </v-card-text>
    ...
    <v-card-text class="px-8">
      Earned credits towards an Associate of Arts in Business
    </v-card-text>
    ...
    <v-card-text class="mb-n7 d-flex justify-space-between">
      <span class="text-subtitle-1 font-weight-bold">Target &#8212; Katy, TX</span><span>February 2019 &#8212; May 2021</span>
    </v-card-text>
    ...
    <v-card-text class="mb-n7 mt-3 d-flex justify-space-between">
      <span class="text-subtitle-1 font-weight-bold">Torchy's Tacos &#8212; Katy, TX</span><span>June 2018 &#8212; February 2019</span>
    </v-card-text>
    <v-card-text class="px-8 my-n7">
      <v-icon x-small class="pa-n9">mdi-rhombus-medium</v-icon>
    ...
    <v-card-text class="mb-n7 mt-3 d-flex justify-space-between">
      <span class="text-subtitle-1 font-weight-bold">Chick-Fil-A &#8212; Katy, TX</span><span>September 2016 &#8212; June 2018</span>
    </v-card-text>
    <v-card-text class="px-8 my-n7">
      <v-icon x-small class="pa-n9">mdi-rhombus-medium</v-icon>
      Sustained a positive drive to ensure management objectives were exceeded
    </v-card-text>
    <v-card-text class="px-8 my-n7">
      <v-icon x-small class="pa-n9">mdi-rhombus-medium</v-icon>
      Always learned new skills and products to promote the Chick-Fil-A brand
    </v-card-text>
    <v-card-text class="px-8 my-n7">
      <v-icon x-small class="pa-n9">mdi-rhombus-medium</v-icon>
      Enthusiastic customer service and consistently reached for goals on every shift
    </v-card-text>
  </v-card>
</template>
